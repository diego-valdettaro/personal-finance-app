...
class TestAccountCreation:
    ...
    def test_create_income_account_success(self, client, sample_user):
        ...
        response = client.post(f"/users/{sample_user.id}/accounts/", json=account_data)
    ...
    def test_create_expense_account_success(self, client, sample_user):
    ...
    def test_create_asset_account_success(self, client, sample_user):
        ...
        response = client.post(f"/users/{sample_user.id}/accounts/asset", json=account_data)
        assert response.status_code == 201
        data = response.json()
        assert data["name"] == account_data["name"]
        assert data["type"] == account_data["type"]
    ...
    def test_create_liability_account_success(self, client, sample_user):
        ...
        response = client.post(f"/users/{sample_user.id}/accounts/liability", json=account_data)
        assert response.status_code == 201
        data = response.json()
        assert data["name"] == account_data["name"]
        assert data["type"] == account_data["type"]
    ...
    def test_create_account_missing_required_fields(self, client, sample_user):
        """Test account creation with missing required fields."""
        # Missing name
        response = client.post(f"/users/{sample_user.id}/accounts/", json={
            "type": "income",
            "user_id": sample_user.id
        })
    ...
    def test_create_asset_account_missing_currency(self, client, sample_user):
    ...
    def test_create_account_duplicate_name(self, client, sample_user):
    ...
    def test_create_account_invalid_type(self, client, sample_user):
...
class TestGetAccounts:
    ...
    def test_get_all_accounts_empty(self, client, sample_user):
        """Test getting all accounts when no accounts exist."""
        response = client.get(f"/users/{sample_user.id}/accounts/", )
        assert response.status_code == 200
        assert response.json() == []
    
    def test_get_all_accounts_multiple(self, client, sample_user):
    ...
    def test_get_account_success(self, client, sample_user):
        ...
        # Get account
        response = client.get(f"/users/{sample_user.id}/accounts/{account['id']}")
        assert response.status_code == 200
        data = response.json()
        assert data["id"] == account["id"]
        assert data["name"] == account["name"]
    
    def test_get_account_not_found(self, client, sample_user):
        """Test getting a non-existent account."""
        response = client.get(f"/users/{sample_user.id}/accounts/99999", )
        assert response.status_code == 404

class TestUpdateAccount:
    """Test cases for updating accounts"""
    
    def test_update_account_name_only(self, client, sample_user):
        ...
        response = client.patch(f"/users/{sample_user.id}/accounts/{account['id']}", json=update_data, )
        assert response.status_code == 200
        data = response.json()
        assert data["name"] == "Updated Name"
        assert data["type"] == account["type"]  # Should remain unchanged
    
    def test_update_account_type(self, client, sample_user):
    ...
    def test_update_account_not_found(self, client, sample_user):
        """Test updating a non-existent account."""
        update_data = {"name": "Updated Name"}
        response = client.patch(f"/users/{sample_user.id}/accounts/99999", json=update_data, )
        assert response.status_code == 404

class TestDeactivateAccount:
    """Test cases for deactivating accounts"""
    
    def test_deactivate_account_success(self, client, sample_user):
        ...
        # Deactivate account
        response = client.patch(f"/users/{sample_user.id}/accounts/{account['id']}/deactivate", )
    ...
    def test_deactivate_account_not_found(self, client, sample_user):
        """Test deactivating a non-existent account."""
        response = client.patch(f"/users/{sample_user.id}/accounts/99999/deactivate", )
        assert response.status_code == 404

class TestActivateAccount:
    """Test cases for activating accounts"""
    
    def test_activate_account_success(self, client, sample_user):
        ...
        # Activate account
        response = client.patch(f"/users/{sample_user.id}/accounts/{account['id']}/activate", )
        assert response.status_code == 204
    ...
    def test_activate_account_not_found(self, client, sample_user):
        """Test activating a non-existent account."""
        response = client.patch(f"/users/{sample_user.id}/accounts/99999/activate", )
        assert response.status_code == 404

class TestAccountValidation:
    """Test cases for account validation and business rules"""
    
    def test_asset_account_currency_required(self, client, sample_user):
    ...
    def test_liability_account_billing_day_validation(self, client, sample_user):
    ...
    def test_liability_account_due_day_validation(self, client, sample_user):
    ...
    def test_income_expense_account_no_currency(self, client, sample_user):
...
class TestAccountEdgeCases:
    ...
    def test_account_name_maximum_length(self, client, sample_user):
    ...
    def test_account_name_too_long(self, client, sample_user):
    ...
    def test_currency_case_handling(self, client, sample_user):
    ...
    def test_opening_balance_negative(self, client, sample_user):
...
class TestAccountIntegration:
    ...
    def test_account_lifecycle(self, client, sample_user):
        ...
        response = client.patch(f"/users/{sample_user.id}/accounts/{account_id}", json=update_data, )
        assert response.status_code == 200
        assert response.json()["name"] == "Updated Lifecycle Account"
        
        # Deactivate account
        response = client.patch(f"/users/{sample_user.id}/accounts/{account_id}/deactivate", )
        assert response.status_code == 204
        ...
        # Activate account
        response = client.patch(f"/users/{sample_user.id}/accounts/{account_id}/activate", )
        assert response.status_code == 204
    ...
    def test_multiple_account_types(self, client, sample_user):
